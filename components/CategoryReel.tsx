        ...
        <div className="relative group/reel">
          ...
          {canScrollLeft && (
            <button
              type="button"
              onClick={() => scroll('left')}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-3 z-20 w-10 h-10 rounded-full bg-white/80 dark:bg-white/[0.06] backdrop-blur-sm shadow-[0_4px_16px_rgba(0,0,0,0.1)] ring-1 ring-black/[0.06] dark:ring-white/[0.1] flex items-center justify-center text-gray-600 dark:text-gray-300 opacity-0 group-hover/reel:opacity-100 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:scale-110 active:scale-95"
          ...
          {canScrollRight && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-3 z-20 w-10 h-10 rounded-full bg-white/80 dark:bg-white/[0.06] backdrop-blur-sm shadow-[0_4px_16px_rgba(0,0,0,0.1)] ring-1 ring-black/[0.06] dark:ring-white/[0.1] flex items-center justify-center text-gray-600 dark:text-gray-300 opacity-0 group-hover/reel:opacity-100 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:scale-110 active:scale-95"
          ...
          {/* Edge fade overlays */}
            <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-blue-50 dark:from-[#06080f] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-blue-50 dark:from-[#06080f] to-transparent z-10 pointer-events-none" />
          ...
          >
            {categories.map((cat, index) => {
              ...
              return (
                ...
                >
                  <div className="rounded-2xl bg-white/80 dark:bg-dark-surface ring-1 ring-black/[0.06] dark:ring-white/[0.08] p-5 md:p-6 text-center transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_12px_32px_rgba(0,0,0,0.3)] hover:ring-[var(--brand-primary)]/20 hover:-translate-y-1 hover-smart-bg">
